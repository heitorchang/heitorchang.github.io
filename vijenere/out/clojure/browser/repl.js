...
var seq__7374_7378 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__7375_7379 = null;
var count__7376_7380 = (0);
var i__7377_7381 = (0);
while(true){
if((i__7377_7381 < count__7376_7380)){
var str_7382 = cljs.core._nth.call(null,chunk__7375_7379,i__7377_7381);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_7382})));
...
var temp__5753__auto___7387 = cljs.core.seq.call(null,seq__7374_7378);
if(temp__5753__auto___7387){
var seq__7374_7388__$1 = temp__5753__auto___7387;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__7374_7388__$1)){
var c__4556__auto___7389 = cljs.core.chunk_first.call(null,seq__7374_7388__$1);
var G__7390 = cljs.core.chunk_rest.call(null,seq__7374_7388__$1);
var G__7391 = c__4556__auto___7389;
var G__7392 = cljs.core.count.call(null,c__4556__auto___7389);
var G__7393 = (0);
...
var str_7394 = cljs.core.first.call(null,seq__7374_7388__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_7394})));
...
var script__$1 = (function (){var G__7403 = script;
goog.object.set(G__7403,"type","text/javascript");

goog.object.set(G__7403,"onload",onload);

goog.object.set(G__7403,"onreadystatechange",onload);

return G__7403;
})();
if((opt_sourceText == null)){
var G__7404 = script__$1;
goog.object.set(G__7404,"src",src);

return G__7404;
} else {
var G__7405 = script__$1;
goog.dom.setTextContent(G__7405,opt_sourceText);
...
var path_7406 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_7406);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_7406)].join(''));
} else {
var path_7407 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_7407);

goog.object.remove(goog.dependencies_.written,path_7407);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_7407)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__7408 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__7409 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__7409);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__7408);
}})()})));
}));

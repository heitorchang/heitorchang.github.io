...
var input = CodeMirror.fromTextArea(replInput, {
  ...
  extraKeys: {
    "Ctrl-Enter": () => { biwaEval(input, true) },
    "Alt-Enter": () => { biwaEval(input, true) },

    "Shift-Ctrl-Enter": () => { biwaEval(input) },
    "Shift-Alt-Enter": () => { biwaEval(input) },
...
const replElem = document.getElementById("editor");
